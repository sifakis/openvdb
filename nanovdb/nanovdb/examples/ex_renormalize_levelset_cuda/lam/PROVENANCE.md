# Provenance of the imported LAM / Sem3D benchmark

Everything under this `lam/` directory is an **unmodified verbatim copy** of the
`Benchmark/` tree from the NVIDIA_Sem3D repository.  It is checked in as a
...
| | |
|---|---|
| Repository | `git@ssh.dev.azure.com:v3/LamCollection1/SemiVerse_Collaboration/NVIDIA_Sem3D` |
| Mirror | `git@github.com:sifakis/NVIDIA_Sem3D.git` |
...
repository.  Fetch them from the Sem3D repository if you need to run the
